...
export const metadata = createMetadata({
  ...
  description:
    "Get a free quote for your website or web app. Web site builders — Chennai, India. Call, WhatsApp, or send a message.",
  path: "/contact",
});
      ...
      <section className="bg-slate-900 py-16 text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="mt-4 max-w-2xl text-lg text-slate-300">
            Free 15-minute consultation. Tell us about your business and we&apos;ll reply within 24 hours.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-slate-800">Mon – Sat, 10:00 AM – 7:00 PM IST</p>
                </div>
              </div>
